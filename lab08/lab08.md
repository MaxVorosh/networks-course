...
![alt text](images/StopAndWait_client_1.png)

Логи на сервере:

![alt text](images/StopAndWait_server_1.png)

Передавался файл example.png и сохранялся в received.png

Контрольные суммы были также реализованы.
...
Передавался файл example.txt и сохранялся в received.txt
